...
{
    public final ReservableInventory.Reservation reservation;
    public final WispInteractionNodeBase inventoryNode;
    public final Direction inventoryDirection;

    public SourcedReservation(@Nonnull ReservableInventory.Reservation reservation, @Nonnull WispInteractionNodeBase inventoryNode, Direction inventoryDirection)
    {
